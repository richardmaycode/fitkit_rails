...
AVAILABLE_EQUIPMENT = %W(mat dumbells bench bench_incline bench_decline kettle_bell resistence_band stability_ball)

for muscle in AVAILABLE_MUSCLES do
    Muscle.create! name: muscle
end

for equipment in AVAILABLE_EQUIPMENT do
...
# Exercise.first.muscles << Muscle.find(4)
